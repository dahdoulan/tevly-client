...
class PendingMoviesTable extends StatelessWidget {
  const PendingMoviesTable({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return DataTable(
      ...
      rows: provider.pendingMovies.map((movie) {
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () => provider.handleReject(context, movie),
                ),
              ],
            ),
          ),
